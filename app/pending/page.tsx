        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-6">
            <div className="text-center space-y-4">
              <p className="text-muted-foreground">Thank you for registering with CME Club Mécatronique ENICarthage!</p>
              <p className="text-muted-foreground">
                Your account is currently pending approval from our administrators. You will receive an email
                notification once your account has been reviewed.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-left">
                    ...
                    <ul className="text-muted-foreground space-y-1">
                      <li>• Admin, President, or HR will review your account</li>
